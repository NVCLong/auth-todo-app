import { Controller, Inject, UseGuards, Get, Param, Patch, Post, Body, Query, Delete, UseInterceptors, ClassSerializerInterceptor } from '@nestjs/common';
...
export class TodoController {
    ...
    async updateNoteStatus(@Param("userId") userId : number, @Query("noteId") noteId: number){
