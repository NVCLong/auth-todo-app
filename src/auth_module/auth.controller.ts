import { Controller, Post, Body, Param, Get , Response, Request, UseGuards, UseInterceptors, ClassSerializerInterceptor, SerializeOptions} from "@nestjs/common";
...
export class AuthController{
    constructor(private authService: AuthService, private readonly logger: TracingService){
